...
public class PolylineDecoder {
     ...
     * @return
     */
    private static List<Location> decode(String encoded, double precision) {
        List<Location> track = new ArrayList<Location>();
        int index = 0;
        int lat = 0, lng = 0;
        ...
        while (index < encoded.length()) {
            ...
            Location p = new Location(lat / precision, lng / precision);
            track.add(p);
        }
        return track;
    }
